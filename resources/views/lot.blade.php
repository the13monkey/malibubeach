...
<main role="main">
        <div class="jumbotron full-height overflow-hidden mb-0 d-flex align-items-center bg-transparent">
            <div class="container text-center" style="margin-top: -2rem;">
                <h1 class="display-4 mb-0 pb-0 text-white font-weight-bold">Private Oceanfront Lot for Sale</h1>
                <p class="display-5 text-white font-weight-bold">Malibu Beach, California</p>
                <p class="display-5 text-white font-weight-bold">John@Doe.com | (123) 456 - 7890</p>
            </div>
        </div>
        <div class="video-container" id="house">
            <video playsinline autoplay muted loop class="video">
                <source src="{{ asset('img/lot.mp4') }}" type="video/mp4">
            </video>
        </div>
